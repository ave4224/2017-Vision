...
import cv2
import numpy as np
from RobustFinding import filterContours, filterContoursFancy
...
def main():
	...
	while True:
		...
		targets = filterContoursFancy(contours) # To be edited if the last filter is changed in case of algorithmic changes. 
